      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="px-2 py-0.5 rounded-full bg-rose-50 text-rose-700 border border-rose-200 text-xs font-bold font-mono shadow-sm">
            ...
            return (
              <div
                ...
                className={`cyber-panel p-4 sm:p-5 transition-all border ${
                  isReviewed
                    ? "opacity-70 border-slate-200 bg-slate-50/70"
                    : alert.derivedSeverity === "CRITICAL"
                    ? "border-red-300 bg-red-50/80 cyber-glow-rose"
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {isReviewed && (
                          <span className="px-2 py-0.5 rounded bg-emerald-50 border border-emerald-200 text-emerald-800 text-[10px] font-semibold flex items-center gap-1">
                      ...
                      {alert.transcript && (
                        <p className="mt-2 text-xs text-slate-700 line-clamp-2 bg-white p-2 rounded border border-slate-200 font-sans shadow-inner">
                  ...
                  <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-center gap-2.5 shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-200">
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-xs font-semibold border transition-colors flex items-center gap-1.5 shadow-sm ${
                        isReviewed
