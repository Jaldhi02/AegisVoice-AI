      ...
      <div className="relative z-10 w-full max-w-md mx-auto">
        <div className="cyber-panel p-6 sm:p-8 relative overflow-hidden shadow-2xl shadow-cyan-950/40">
          ...
          <div className="text-center mb-6">
            <div className="inline-flex p-3 rounded-2xl bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 mb-2.5 shadow-lg shadow-cyan-500/10">
            ...
            <div className="mb-5 p-3 rounded-xl bg-slate-900/90 border border-cyan-500/30 flex items-center justify-between gap-3 text-xs shadow-sm">
              ...
              <button
                ...
                className="px-2.5 py-1.5 rounded-lg bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-300 border border-cyan-500/40 font-semibold transition-all hover:scale-105 shrink-0 text-xs shadow-sm shadow-cyan-500/10"
              >
                Auto-Fill
              </button>
            </div>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-slate-900/90 border border-slate-700 text-slate-100 placeholder-slate-500 text-sm focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all shadow-inner"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full pl-10 pr-10 py-2.5 rounded-lg bg-slate-900/90 border border-slate-700 text-slate-100 placeholder-slate-500 text-sm focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all shadow-inner"
                  />
                  <button
                    type="button"
            ...
            <div className="mt-6 pt-5 border-t border-slate-800 text-center text-xs text-slate-400">
              ...
              <Link to="/register" className="font-semibold text-cyan-400 hover:text-cyan-300 transition-colors underline decoration-cyan-500/40 hover:decoration-cyan-400">
                Register Clearance
              </Link>
            </div>
          </div>
