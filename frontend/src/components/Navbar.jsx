      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            <div className="p-2 rounded-lg bg-sky-500/10 border border-sky-500/20 text-sky-600 group-hover:bg-sky-500/20 transition-colors">
              <Shield className="w-5 h-5" />
            </div>
            <div>
              <span className="font-bold text-slate-900 text-base tracking-tight flex items-center gap-1.5">
                AegisVoice <span className="text-sky-600">AI</span>
              </span>
        ...
        <div className="hidden lg:flex items-center gap-3">
          <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-xs">
            ...
            <span className="text-emerald-600 font-mono text-[11px] font-semibold">ACTIVE SCANNING</span>
          </div>
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-2.5 py-1 text-xs rounded-full border transition-all ${
              isMock
                ? "bg-amber-50 border-amber-300 text-amber-800 shadow-sm hover:bg-amber-100"
          ...
          >
            ...
            <span className={`font-bold font-mono text-[11px] ${isMock ? "text-amber-700" : "text-slate-500"}`}>
              {isMock ? "ON" : "OFF"}
            </span>
          </button>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          {isAuthenticated ? (
            <>
              ...
              <Link
                to="/analysis"
                className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg bg-sky-600 hover:bg-sky-700 text-white transition-colors shadow-sm shadow-sky-600/20"
              >
              ...
              >
                <div className="w-8 h-8 rounded-full bg-slate-100 border border-slate-300 flex items-center justify-center text-sky-700 font-semibold text-xs">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                to="/register"
                className="px-3 py-1.5 text-xs font-semibold rounded-lg bg-sky-600 hover:bg-sky-700 text-white transition-colors shadow-sm"
              >
                Register
              </Link>
            </div>
